...
# Greedy tree traversal using UCT
# False -> recursive, True -> iterative
...
class MCTSNode:
    ...
    def __str__(self) -> str:
        return f'[NODE] N={self.N} Q={self.Q} MV={self.move}'
...
class MCTS:
    ...
    def pick_move(self, temp: float = 1e-3
        ...
        new_probs = softmax(1 / temp * np.log(np.array(visits) + 1e-10))
        # give this a try
